...
public class AvroSchemaTest {
    ...
    public void forClass() throws Exception {
        ...
        assertEquals("{\"type\":\"record\",\"name\":\"TestDataWithSubSchemaInCollection\",\"namespace\":\"org.sv.flexobject.testdata\",\"fields\":[{\"name\":\"intField\",\"type\":[\"null\",\"int\"]},{\"name\":\"intFieldOptional\",\"type\":[\"null\",\"int\"]},{\"name\":\"json\",\"type\":[\"null\",\"string\"]},{\"name\":\"subStructArray\",\"type\":[\"null\",{\"type\":\"array\",\"items\":[\"null\",{\"type\":\"record\",\"name\":\"TestDataWithInferredSchema\",\"fields\":[{\"name\":\"intField\",\"type\":[\"null\",\"int\"]},{\"name\":\"intFieldOptional\",\"type\":[\"null\",\"int\"]},{\"name\":\"intFieldStoredAsString\",\"type\":[\"null\",\"string\"]},{\"name\":\"intFieldStoredAsStringOptional\",\"type\":[\"null\",\"int\"]},{\"name\":\"intArray\",\"type\":[\"null\",{\"type\":\"array\",\"items\":[\"null\",\"int\"]}]},{\"name\":\"intList\",\"type\":[\"null\",{\"type\":\"array\",\"items\":[\"null\",\"int\"]}]},{\"name\":\"intMap\",\"type\":[\"null\",{\"type\":\"map\",\"values\":[\"null\",\"int\"]}]},{\"name\":\"json\",\"type\":[\"null\",\"string\"]}]}]}]},{\"name\":\"subStructList\",\"type\":[\"null\",{\"type\":\"array\",\"items\":[\"null\",\"TestDataWithInferredSchema\"]}]},{\"name\":\"subStructMap\",\"type\":[\"null\",{\"type\":\"map\",\"values\":[\"null\",\"TestDataWithInferredSchema\"]}]}]}"
                , avroSchema.toString());
    }
